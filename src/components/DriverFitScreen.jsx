...
function DriverFitScreen({ load, drivers, runtimePositions = {}, gameTime, candidateDriverId, onEvaluate, onBack, tutorialEnabled = false, showTutorialNote = false, tutorialTarget = null }) {
  ...
  return (
    <div className="phone-page driver-fit-screen">
      <div className="driver-fit-content">
        <h1>Check Driver Fit</h1>{showTutorialNote && <div className="tutorial-note"><strong>DISPATCH NOTE</strong><span>Driver Fit checks deadhead distance, arrival time, and appointment fit so you know whether Marcus can run the load.</span></div>}
