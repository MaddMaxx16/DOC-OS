function HomeScreen({ onOpenBrowser, onOpenDocuments, onOpenLedger, onOpenEmail, emailBadgeCount = 0, documentsBadgeCount = 0, ledgerUnreadCount = 0 }) {
  return (
